      ...
      <div className="container flex h-14 items-center justify-between">
        <div className="flex items-center gap-10">
          <Link to="/" className="flex items-center gap-2.5">
            <img src={lunexLogo} alt="LUNEX" className="h-7 w-auto rounded-sm dark:brightness-110 dark:contrast-110" style={{ mixBlendMode: 'multiply' }} />
            <span className="text-lg font-bold text-foreground tracking-widest uppercase">LUNEX</span>
          </Link>
