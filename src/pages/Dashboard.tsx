    ...
    <div className="container max-w-5xl mx-auto py-16 px-4">
      ...
      <div className="grid lg:grid-cols-4 gap-8">
         ...
         <div className="space-y-6">
            <div className="p-6 border border-border bg-primary/5 rounded-sm">
               <h4 className="text-[10px] font-bold uppercase tracking-widest text-primary mb-4">Portfolio Score</h4>
               <p className="text-4xl font-bold font-mono text-primary">AA+</p>
               <p className="text-[8px] text-muted-foreground font-bold uppercase mt-2 leading-relaxed">
                  Calculated based on asset distribution and provision longevity
               </p>
            </div>

            <div className="p-6 border border-border bg-card rounded-sm">
               <h4 className="text-[10px] font-bold uppercase tracking-widest mb-4">Integrity Check</h4>
               <div className="space-y-3">
                  <div className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-green-500" /><span className="text-[8px] font-bold uppercase tracking-widest">Assets Verified</span></div>
                  <div className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-green-500" /><span className="text-[8px] font-bold uppercase tracking-widest">Shares Synced</span></div>
                  <div className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-green-500" /><span className="text-[8px] font-bold uppercase tracking-widest">Yield Compounding</span></div>
               </div>
            </div>
         </div>
      </div>
