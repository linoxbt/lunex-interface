  ...
  return (
    <div className="container max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-px bg-border mb-6">
        <div className="p-5 bg-card flex flex-col items-center text-center"><div className="h-8 w-8 bg-primary/10 flex items-center justify-center mb-3"><DollarSign className="h-4 w-4 text-primary" /></div><p className="text-xs text-muted-foreground tracking-wider">TVL</p><p className="text-xl font-bold font-mono">${fmt(totalTvl)}</p></div>
        <div className="p-5 bg-card flex flex-col items-center text-center"><div className="h-8 w-8 bg-primary/10 flex items-center justify-center mb-3"><BarChart3 className="h-4 w-4 text-primary" /></div><p className="text-xs text-muted-foreground tracking-wider">TOTAL VOLUME</p><p className="text-xl font-bold font-mono">${fmt(totalVolume)}</p></div>
        <div className="p-5 bg-card flex flex-col items-center text-center"><div className="h-8 w-8 bg-primary/10 flex items-center justify-center mb-3"><Droplets className="h-4 w-4 text-primary" /></div><p className="text-xs text-muted-foreground tracking-wider">POOL LIQUIDITY</p><p className="text-xl font-bold font-mono">${fmt(pool.totalLiquidity)}</p></div>
        <div className="p-5 bg-card flex flex-col items-center text-center"><div className="h-8 w-8 bg-primary/10 flex items-center justify-center mb-3"><Shield className="h-4 w-4 text-primary" /></div><p className="text-xs text-muted-foreground tracking-wider">USDC VAULT TVL</p><p className="text-xl font-bold font-mono">${fmt(usdcVault.totalAssets)}</p></div>
        {/* Last item spans full width on mobile to avoid blank square */}
        <div className="p-5 bg-card col-span-2 lg:col-span-1 flex flex-col items-center text-center"><div className="h-8 w-8 bg-primary/10 flex items-center justify-center mb-3"><Shield className="h-4 w-4 text-primary" /></div><p className="text-xs text-muted-foreground tracking-wider">EURC VAULT TVL</p><p className="text-xl font-bold font-mono">${fmt(eurcVault.totalAssets)}</p></div>
      </div>
