    ...
    <div className="page-fade-in">
      ...
      <section className="container py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-px bg-border">
          ...
          <div className="flex items-center gap-4 bg-background p-6 justify-center md:justify-start"><div className="flex h-10 w-10 items-center justify-center bg-accent/10"><BarChart3 className="h-5 w-5 text-accent-foreground" /></div><div className="text-center md:text-left"><p className="text-xs text-muted-foreground tracking-wider">TOTAL VOLUME</p><p className="text-xl font-bold font-mono">${fmt(volume.totalVolume)}</p></div></div>
